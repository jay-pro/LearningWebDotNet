...
function ModalEditAssignment({ mdetail }) {
  console.log(mdetail);
  ...
  const url =
    "https://todoapi20210730142909.azurewebsites.net/api/Teachers/assignment/edit";
  ...
  return (
    <div className="wrapper-dashboard ">
      <div className="wrapper-flex ">
        <h1 className="title-name-create">Edit assignment </h1>
